import { Heading, Text, UnorderedList, ListItem, OrderedList, Divider, Box, styled } from "@chakra-ui/react"
...
const components = {
  ...
  hr: (props: any) => <Divider borderBottomColor={"brand.300"} my={4} as="hr" {...props} />,
  ...
  img: (props: any) => {
    return <Box position={'relative'}
      ...
      overflow={'hidden'}
    >
      < NextImage width="1202" height="1000" {...props} />
    </Box>
  },
